...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        pytorch_weight_path="/mnt/data/weiyang.hu/models/openpi/pi05_base_pytorch",
        num_train_steps=50000,
        fsdp_devices=4,  # refer line 359
        save_interval=5000,
    ),
    # pi05_base by lora（只训 LoRA，显存更省）
    TrainConfig(
    ...
    TrainConfig(
        ...
        data=SimpleDataConfig(
            ...
            data_transforms=lambda model: _transforms.Group(
                inputs=[droid_policy.DroidInputs(action_dim=model.action_dim, model_type=ModelType.PI0)],
