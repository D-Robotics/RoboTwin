...
def restore_params(
    ...
    *,
    ...
    # checkpoints.save_checkpoint("/mnt/data/weiyang.hu/RoboTwin-main/policy/pi0/ckpt_dir", target=params, step=0, prefix="pi0_")
    # exit(1)
    ...
    # 把 tuple key 转成字符串 key
    str_flat_params = {".".join(kp): np.array(v) for kp, v in flat_params.items()}

    # 保存
    np.savez("pi0_params.npz", **str_flat_params)
